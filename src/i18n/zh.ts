...
const zh: Record<TranslationKey, string> = {
  ...
  'messageInput.noCommandsFound': '未找到匹配的命令',
  ...
  'plugins.noPluginsDesc': '通过 Claude Code 插件市场安装插件，以添加技能、命令和智能体。',
  'plugins.noSelected': '未选择插件',
  'plugins.selectHint': '选择一个插件以查看其详情和资源',
  'plugins.searchPlugins': '搜索插件...',
  'plugins.version': '版本',
  'plugins.author': '作者',
  'plugins.license': '许可证',
  'plugins.installedAt': '安装时间',
  'plugins.updatedAt': '更新时间',
  'plugins.scope': '作用域',
  'plugins.installPath': '安装路径',
  'plugins.notFound': '磁盘上未找到安装路径',
  'plugins.keywords': '标签',
  'plugins.resources': '资源',
  'plugins.noResources': '此插件中未找到技能、命令或智能体',
  'plugins.skills': '技能',
  'plugins.commands': '命令',
  'plugins.agents': '子智能体',
  'plugins.mcp': 'MCP 配置',
  'plugins.hasMcp': '此插件包含 MCP 服务器配置',
  'plugins.resourceCount': '{count} 个资源',
  'plugins.resourceCountPlural': '{count} 个资源',
  ...
  'bridge.popoChannelDesc': '通过网易 POPO 机器人接收和回复消息',
  'bridge.popoSettings': 'POPO 设置',
  'bridge.popoSettingsDesc': '配置桥接使用的 POPO 应用机器人凭据',

  // ── Settings: POPO Bridge ─────────────────────────────────────
  'popo.credentials': '应用凭据',
  'popo.credentialsDesc': '输入您的 POPO App Key 和 App Secret',
  'popo.appKey': 'App Key',
  'popo.appSecret': 'App Secret',
  'popo.robotEmail': '机器人邮箱',
  'popo.robotEmailDesc': '发送消息时使用的机器人邮箱账号（可选，新版 API 不需要）',
  'popo.webhookToken': 'Webhook Token',
  'popo.webhookTokenDesc': '在 POPO 开发者后台事件订阅中配置的 token，用于签名验证',
  'popo.aesKey': 'AES Key（消息加密密钥）',
  'popo.aesKeyDesc': '在 POPO 开发者后台事件订阅中配置的加密密钥，用于解密消息体',
  'popo.verify': '测试连接',
  'popo.verified': '连接验证成功',
  'popo.verifyFailed': '连接失败',
  'popo.enterCredentialsFirst': '请先输入 App Key 和 App Secret',
  'popo.webhookUrl': 'Webhook 接收地址',
  'popo.webhookUrlDesc': '将此地址填入 POPO 开发者后台的事件订阅配置中',
  'popo.internalUrl': '内网直连地址',
  'popo.internalUrlDesc': '公司内网使用（推荐），需确保 POPO 服务器可访问此机器',
  'popo.internalUrlUnavailable': '无法检测到内网 IP，请检查网络接口配置',
  'popo.tunnelSection': 'Cloudflare 穿透',
  'popo.tunnelDesc': '需要跨网络访问时启用，每次启动后地址会变化',
  'popo.startTunnel': '启动 Tunnel',
  'popo.stopTunnel': '停止 Tunnel',
  'popo.tunnelStarting': '正在建立连接...',
  'popo.tunnelRunning': '穿透已连接',
  'popo.tunnelStopped': '未启动',
  'popo.tunnelError': '连接失败',
  'popo.allowedUsers': '允许的用户',
  'popo.allowedUsersDesc': '允许使用桥接的用户邮箱，逗号分隔，留空则允许所有人',
  'popo.notifyEmail': '消息通知邮箱',
  'popo.notifyEmailDesc': 'Claude 回复完成、需要权限确认或发生错误时，通过 POPO 向此邮箱推送通知（与系统级提醒场景一致）；留空则不推送',
  'popo.setupGuide': '设置指南',
  'popo.step1': '访问 POPO 开发者后台 (open-dev.popo.netease.com) 创建应用机器人',
  'popo.step2': '在「凭证与基础信息」获取 App Key 和 App Secret，填入上方',
  'popo.step3': '在「开发管理」→「事件订阅」中填入上方生成的 Webhook 地址及 Token',
  'popo.step4': '申请回调权限：IM_P2P_TO_ROBOT_MSG、IM_CHAT_TO_ROBOT_AT_MSG',
  'popo.step5': '点击「测试连接」验证凭据是否正确',
