...
const en = {
  ...
  'bridge.popoChannel': 'POPO',
  'bridge.popoChannelDesc': 'Receive and respond to messages via NetEase POPO Robot',
  'bridge.popoSettings': 'POPO Settings',
  'bridge.popoSettingsDesc': 'Configure POPO application robot credentials for bridge',

  // ── Settings: POPO Bridge ─────────────────────────────────────
  'popo.credentials': 'App Credentials',
  'popo.credentialsDesc': 'Enter your POPO App Key and App Secret',
  'popo.appKey': 'App Key',
  'popo.appSecret': 'App Secret',
  'popo.robotEmail': 'Robot Email',
  'popo.robotEmailDesc': 'Robot email account used as sender (optional for new API)',
  'popo.webhookToken': 'Webhook Token',
  'popo.webhookTokenDesc': 'Token configured in POPO developer console for signature verification',
  'popo.aesKey': 'AES Key (Message Encryption Key)',
  'popo.aesKeyDesc': 'AES key configured in POPO developer console for decrypting message body',
  'popo.verify': 'Test Connection',
  'popo.verified': 'Connection verified',
  'popo.verifyFailed': 'Connection failed',
  'popo.enterCredentialsFirst': 'Enter App Key and App Secret first',
  'popo.webhookUrl': 'Webhook URL',
  'popo.webhookUrlDesc': 'Paste this URL into the event subscription config in POPO developer console',
  'popo.internalUrl': 'Internal Network URL',
  'popo.internalUrlDesc': 'For company intranet use (recommended) — ensure POPO server can reach this machine',
  'popo.internalUrlUnavailable': 'Unable to detect internal IP — check network interface configuration',
  'popo.tunnelSection': 'Cloudflare Tunnel',
  'popo.tunnelDesc': 'Enable for cross-network access — URL changes on each start',
  'popo.startTunnel': 'Start Tunnel',
  'popo.stopTunnel': 'Stop Tunnel',
  'popo.tunnelStarting': 'Establishing connection...',
  'popo.tunnelRunning': 'Tunnel connected',
  'popo.tunnelStopped': 'Not started',
  'popo.tunnelError': 'Connection failed',
  'popo.allowedUsers': 'Allowed Users',
  'popo.allowedUsersDesc': 'User emails allowed to use bridge, comma-separated. Empty = allow all.',
  'popo.notifyEmail': 'Message Notification Email',
  'popo.notifyEmailDesc': 'Send a POPO notification to this email on reply complete, permission request, or error — same triggers as system notifications. Leave empty to disable.',
  'popo.setupGuide': 'Setup Guide',
  'popo.step1': 'Visit POPO developer console (open-dev.popo.netease.com) and create an application robot',
  'popo.step2': 'Get App Key and App Secret from "Credentials & Basic Info", paste above',
  'popo.step3': 'In "Development Management" → "Event Subscription", enter the Webhook URL and Token above',
  'popo.step4': 'Apply for callback permissions: IM_P2P_TO_ROBOT_MSG, IM_CHAT_TO_ROBOT_AT_MSG',
  'popo.step5': 'Click "Test Connection" to verify credentials',
